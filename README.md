...
### Telegram бот
К проекту привязан Telegram бот, который посылает уведомления о коммитах: название коммита, в каком репозитории, а также статус прохождения тестов: passing (все тесты пройдены) или failing (есть ошибки в работе).
